 ...
 */
export declare function ownsSelection(this: Editor, locator: Locator): Promise<boolean>;
/**
 ...
 * @param this
 */
export declare function getFocusOwnerLabel(this: Editor): Promise<string>;
//# sourceMappingURL=owns-selection.d.ts.map